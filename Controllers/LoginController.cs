...
namespace H3ProjektAPI.Controllers
{
        ...
        public IActionResult Login(string username, string password)
            ...
            if (manager.CheckUsername(username, data))
            {
                ...
                if (manager.ValidatePassword(password, username, salt, dbHashedPass) == true)
                {
                    ...
                    var tokenOptions = new JwtSecurityToken(issuer: "http://localhost:19113", audience: "http://localhost:19113", claims: new List<Claim>(), expires: DateTime.Now.AddSeconds(15), signingCredentials: signingCredentials);
